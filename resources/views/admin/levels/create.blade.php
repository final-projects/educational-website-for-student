    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.levels.store') }}" method="POST"
                ...
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">🎓 Level Information</h3>
                ...
                <div>
                    ...
                    <input type="number" name="min_age" id="min_age" value="{{ old('min_age') }}"
                           class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-md shadow-sm" min="0" max="100">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_age" id="max_age" value="{{ old('max_age') }}"
                           class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-md shadow-sm" min="0" max="100">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order') }}"
                           class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-md shadow-sm" min="0">
                </div>
